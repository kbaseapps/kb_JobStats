...
function kb_JobStats(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.get_app_metrics = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_JobStats.get_app_metrics",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "kb_JobStats.status",
